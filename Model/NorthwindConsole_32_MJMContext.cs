...
{
    public partial class NorthwindConsole_32_MJMContext : DbContext
    {
        public NorthwindConsole_32_MJMContext()
        {
        }

        public NorthwindConsole_32_MJMContext(DbContextOptions<NorthwindConsole_32_MJMContext> options)
            : base(options)
        {
        }
